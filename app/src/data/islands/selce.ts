...
export const selce: IslandContent = {
  ...
  activities: [
    ...
    },
    {
      ...
      description: t(
        'A Selce jet-ski rental with safety equipment and an on-site briefing before you head out on the water.',
        'Najam jet-skija u Selcu sa sigurnosnom opremom i kratkim uputama prije izlaska na more.',
        'Jetski-Verleih in Selce mit Sicherheitsausrüstung und einer kurzen Einweisung vor der Fahrt.',
        'Noleggio di jet ski a Selce con attrezzatura di sicurezza e una breve spiegazione prima di uscire in mare.',
        'Najem jet-skijev v Selcah z varnostno opremo in kratkimi navodili pred odhodom na morje.',
        'Wypożyczalnia skuterów wodnych w Selce ze sprzętem bezpieczeństwa i krótkimi instrukcjami przed wypłynięciem.',
        'Půjčovna vodních skútrů v Selci s bezpečnostním vybavením a krátkými instrukcemi před vyplutím.',
        'Jet-ski kölcsönző Selcében, biztonsági felszereléssel és rövid tájékoztatással indulás előtt.',
        'Požičovňa vodných skútrov v Selciach s bezpečnostnou výbavou a krátkymi pokynmi pred vyplávaním.',
      ),
